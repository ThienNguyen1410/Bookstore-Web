...
<html lang="en" class="no-touchevents flexbox csscolumns csscolumns-width csscolumns-span csscolumns-fill csscolumns-gap csscolumns-rule csscolumns-rulecolor csscolumns-rulestyle csscolumns-rulewidth csscolumns-breakbefore csscolumns-breakafter csscolumns-breakinside smil">
    ...
    <body onload="startTime()">
     ...
     <div class="body_history">
        <table style="width: 100%; border-width: 2px; border-color: gray;">
          <thead>
            <tr>
          ...
          <tbody>
             <%CartDao hisD = new CartDao();
               for(HistoryGet his : hisD.showHistory(cus.getUserName())){
             %>
             <tr>
                <td align="center"><span><%=his.getpID()%></span></td>
                <td align="center"><span><%=his.getpType() %></span></td>
                <td align="center"><span><%=his.getTotalPrice()%></span></td>
             </tr>
             <%} %>
          </tbody>
        </table>
