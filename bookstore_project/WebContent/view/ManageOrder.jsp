        ...
        <div class="mainside">  
          ...
          <div class="UpdateQuan">
             ...
             <form name="updateForm" id="updateForm" action="${pageContext.request.contextPath}/AdminUpdateBook" method="get">
              <span>Name:</span><br><input type="text" name="updateName"  class="updateName" id="updateName"required><br>
              <span>Author:</span><br><input type="text" name="updateAuthor" class="updateAuthor" id="updateAuthor"required><br>
