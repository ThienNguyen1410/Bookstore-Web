...
<html lang="en" class="no-touchevents flexbox csscolumns csscolumns-width csscolumns-span csscolumns-fill csscolumns-gap csscolumns-rule csscolumns-rulecolor csscolumns-rulestyle csscolumns-rulewidth csscolumns-breakbefore csscolumns-breakafter csscolumns-breakinside smil">
    ...
    <body onload="startTime()">
        ...
        <div class="sidebar">
          <a href="profile_user">About</a>
          <a href="#services">Payment</a>
          <a href="#clients">Wishlist</a>
        ...
        <div class="mainside">
          ...
          <h2>User name</h2>
          <p><input type="text" name="profile_user_name" value ="<%= session.getAttribute("username")%>" readonly></p>
          <p></p>
          <hr style="background-color: black;">
          <h2>Email</h2>
          <p><input type="text" name="profile_email" value ="<%= session.getAttribute("emailTake")%>" readonly></p>
          <p></p>
          <hr style="background-color: black;">
          <h2>Password</h2>
          <p><input type="password" name="profile_pass" value ="<%= session.getAttribute("passTake")%>" readonly></p>
          <p></p>
          <hr style="background-color: black;">
        </div>  
    </body>
